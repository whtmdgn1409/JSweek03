...
function parser(lexemes) {
  ...
  lexemes.forEach(lexeme => {
    let [tagName, ...attributes] = lexeme.value.split(" ");
    attributes = attributes.reduce((res, cur) => {
    ...
    switch (lexeme.type) {
      ...
      case "closeTag":
        ...
        break;
      case "text":
        current.push({ value: lexeme.value, type: "textNode" });
        break;
      default:
        break;
    }
